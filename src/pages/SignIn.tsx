...
const SignIn = () => {
  ...
  const handleDemoLogin = async (role: 'admin' | 'team_leader' | 'team_member') => {
    const credentials = {
      admin: { email: 'admin@smarttasker.ai', password: 'password123' },
      team_leader: { email: 'teamlead@smarttasker.ai', password: 'password123' },
      team_member: { email: 'member@smarttasker.ai', password: 'password123' }
    };

    setLoading(true);
    try {
      const user = await login(credentials[role].email, credentials[role].password);
      toast({
        title: 'Demo Access Granted!',
        description: `Exploring as ${role.replace('_', ' ')} - ${user.name}`,
      });
  ...
  return (
    <div className="min-h-screen w-full relative bg-gradient-to-br from-slate-950 via-blue-950/90 to-purple-950/90">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute top-1/4 left-1/4 w-72 h-72 bg-blue-500/10 rounded-full blur-3xl animate-pulse duration-[4s]"></div>
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-purple-500/10 rounded-full blur-3xl animate-pulse duration-[6s] delay-1000"></div>
        <div className="absolute top-1/2 right-1/3 w-64 h-64 bg-green-400/10 rounded-full blur-3xl animate-pulse duration-[5s] delay-2000"></div>
      </div>
        ...
        <div className="w-full max-w-7xl grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="space-y-6 text-center lg:text-left">
            ...
            <div className="pt-4 space-y-3">
              ...
              <Button
                ...
                className="ml-3 bg-gradient-to-r from-green-600 to-blue-600 hover:from-green-700 hover:to-blue-700 text-white backdrop-blur-sm transition-all duration-300 hover:scale-105"
              >
          ...
          <div className="space-y-6 w-full max-w-md mx-auto lg:max-w-none">
            ...
            {!showDemo ? (
              ...
              /* Demo Access Panel */
              <Card className="backdrop-blur-xl bg-white/10 border border-white/20 shadow-2xl hover:shadow-green-500/20 transition-all duration-500">
                <CardHeader className="space-y-1 pb-4">
                  <CardTitle className="text-xl text-center text-white flex items-center justify-center space-x-2">
                  ...
                  <CardDescription className="text-center text-gray-300">
                    Choose your role to explore SmartTasker AI
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <Button
                    ...
                    disabled={loading}
                    className="w-full bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white py-4 text-left justify-start transition-all duration-300 hover:scale-[1.02]"
                  >
                    <Shield className="h-5 w-5 mr-3" />
                    <div>
                      <div className="font-semibold">Admin Access</div>
                      <div className="text-xs opacity-80">Full system control, user management, analytics</div>
                    </div>
                  </Button>
                  ...
                  <Button
                    ...
                    disabled={loading}
                    className="w-full bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white py-4 text-left justify-start transition-all duration-300 hover:scale-[1.02]"
                  >
                    <Users className="h-5 w-5 mr-3" />
                    <div>
                      <div className="font-semibold">Team Leader Access</div>
                      <div className="text-xs opacity-80">Manage team, assign tasks, track progress</div>
                    </div>
                  </Button>
                  ...
                  <Button
                    ...
                    disabled={loading}
                    className="w-full bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 text-white py-4 text-left justify-start transition-all duration-300 hover:scale-[1.02]"
                  >
                    <Layers className="h-5 w-5 mr-3" />
                    <div>
                      <div className="font-semibold">Team Member Access</div>
                      <div className="text-xs opacity-80">View tasks, update progress, collaborate</div>
                    </div>
                  </Button>
